        ...
        <div className="">
          <div className="wrap flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div
              ...
              <ul className="font-medium flex flex-col justify-center items-center lg:border-0 p-4 lg:p-0 lg:px-4 mt-4 border-b border-primaryP/40 rounded-lg  lg:flex-row lg:space-x-8 rtl:space-x-reverse lg:mt-0 text-text gap-3 ">
                ...
                <a
                  ...
                  target='_blank'
                  href="https://docs.google.com/document/d/1KJ26tzCsqVivntzXP8rzTP59L7bbOBnFlaf9p7k0KAg/edit?usp=drive_link">
                  <Btn text="Resume" />
                </a>
              </ul>
            ...
            <div className=" hidden lg:flex items-center gap-3">
              ...
              <a target='_blank'  href="https://docs.google.com/document/d/1KJ26tzCsqVivntzXP8rzTP59L7bbOBnFlaf9p7k0KAg/edit?usp=drive_link">
              <Btn text="Resume" /></a>
